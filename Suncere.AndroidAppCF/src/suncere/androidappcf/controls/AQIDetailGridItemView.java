    ...
    public boolean dispatchTouchEvent(MotionEvent event)
    {
     ...
     private class AQIDetailGridViewAdapter extends SimpleAdapter {
    	...
    	public View getView(int position,View convertView,ViewGroup parent)
    	{
    		...
    		iv.setBackgroundColor( Convert.toInt(  AQITool.GetAQIResourceByAQ( Convert.toInt(dataSource.get(position).get("state")) , AQITool.AQIPresentEnum.Color)));
    		
    		TextView tv=(TextView)view.findViewById(R.id.advgiPollutantName);
    		tv.setText( PollutantNameFormatTool.GetInstance().ConvertPollutantAndUnitText(tv.getText().toString(), tv.getTextSize()));
