...
public class TimeSegmentChecker implements IChecker {
	...
	public boolean ExistData(HashMap<String, Object> parameter) {
		...
		try {
			String timeStr=(String) timepointGetter.invoke(dataFirst, (Object[]) null);
			String timeRangeValue=(String) timeRangeValueGetter.invoke(dataFirst, (Object[]) null);
			int timeRange=  (Integer) timeRangeGetter.invoke(dataFirst, (Object[]) null);
