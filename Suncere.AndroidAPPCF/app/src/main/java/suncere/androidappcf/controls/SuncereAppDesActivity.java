...
//					intent.setClass(SuncereApplication.CurrentApplication().CurrentActivity(),mainActivityClass);
	...
	private View CreateView()
	{
		...
		LayoutParams pcLayoutParam =(LayoutParams) pagerControl.getLayoutParams();
		pcLayoutParam.height= LayoutParams.WRAP_CONTENT;
		pcLayoutParam.width= LayoutParams.WRAP_CONTENT;
...
//		btn.setTextSize(ScreenSuitableTool.ConvertSuitableDpi(18));
		...
		LayoutParams btnLayoutParam=(LayoutParams) btn.getLayoutParams();
		btnLayoutParam.height= LayoutParams.WRAP_CONTENT;
		btnLayoutParam.width= LayoutParams.WRAP_CONTENT;
