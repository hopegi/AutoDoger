...
//	 * @return
//	 */
//	public static HashMap<String,Object>parseHashMap(JSONObject js)
//	{
//		HashMap<String,Object> result=new HashMap<String,Object>();
//		String key;
//		
//		for(Iterator iter=js.keys();iter.hasNext();)
//		{
//			key=iter.next().toString();
//			try {
//				result.put(key, js.getString(key));
...
//	 * @return
//	 */
//	public static List<HashMap<String,Object>>parseHashMapList(String js)
//	{
...
//		{
//			try {
//				result.add(parseHashMap(jo.getJSONObject(i)));
//			} catch (JSONException e) {
//				// TODO Auto-generated catch block
//				e.printStackTrace();
//			}
...
//	}
	...
	public static String parseMethodName(String fieldName,String methodType) {
		...
		if(fieldName.startsWith("_"))
			return methodType + fieldName.substring(1, 2).toUpperCase() + fieldName.substring(2);
		else
...
//			return (T[]) parseHashMapList(jsonStr).toArray();
		...
		try {
			if (isArray(clazz)) { // 数组
				...
				{//处理枚举
					Object o=jo.opt(name);
					if(o!=null){
						o= clazz.getMethod("valueOf",String.class).invoke(obj, o);
						setFiedlValue(obj, fieldSetMethod, clazz.getSimpleName(), o);
					}
				}
